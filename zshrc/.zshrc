...
plugins=(git tmux vi-mode zoxide zsh-autosuggestions zsh-syntax-highlighting)
...
export PATH="$HOME/nvm/versions/node/v21:$PATH"
export PATH="$HOME/fzf/bin:$PATH"
export PATH="/bin/usr/racket/bin:$PATH"
